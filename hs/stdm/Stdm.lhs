...
>   do let (valid, ms, uda, concl) = Stdm.traverse db proof                    -- *2
...
>   let (avalid, amsgs, auda, aconcl) = Stdm.traverse db a                     -- *2
>       (bvalid, bmsgs, buda, bconcl) = Stdm.traverse db b                     -- *2
>       (ok, msg) =                                                       -- *
>         case c of                                                       -- *
...
>   let (avalid, amsgs, auda, aconcl) = Stdm.traverse db a                     -- *2
>       (bvalid, bmsgs, buda, bconcl) = Stdm.traverse db b                     -- *2
>       (cvalid, cmsgs, cuda, cconcl) = Stdm.traverse db c                     -- *2
>       (ok,msg,uda) =                                                    -- *
>         case aconcl of                                                  -- *
...
>                        return ()
>                else return ()
>   where handler :: IOException -> IO String
>         handler err = return ""
